...
/** Closing call-to-action for the contact page. */
const ContactCta = () => {
    return (
            ...
            <div className="relative overflow-hidden rounded-[2rem] bg-linear-to-br from-primary-500 to-primary-600 px-6 py-14 text-center md:px-12 md:py-20">
                ...
                <div className="relative mx-auto flex max-w-2xl flex-col items-center gap-6">
                    ...
                    <p className="text-white/90 md:text-lg">
                        Explore coworking spaces, private offices and virtual offices across Kerala at
                        your own pace — then call or message us whenever you’d like a hand narrowing
                        it down.
                    </p>
